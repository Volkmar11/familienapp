...
// ─── LOCAL STORAGE ───
const SK = "famchores-shared-v2";
const save = async (data) => { try { localStorage.setItem(SK, JSON.stringify(data)); } catch(e) { console.error(e); } };
const load = async () => { try { const r = localStorage.getItem(SK); return r ? JSON.parse(r) : null; } catch { return null; } };
